...
export class QuotaService {
  ...
  // ultimately failed: give the user their quota back and drop the usage log so it never
  // counts toward cost analytics. Which period counter to refund follows the log's own
  // action, so one method serves both quota families.
