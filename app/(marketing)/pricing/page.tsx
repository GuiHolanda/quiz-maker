    ...
    <div className="bg-navy-900 text-foreground">
        ...
        <div className="relative overflow-hidden grid-bg">
          ...
          <section className="py-20 px-6 text-center relative z-10">
            <div className="max-w-3xl mx-auto flex flex-col items-center gap-6">
              ...
              <p className="text-sm text-navy-400 leading-relaxed max-w-xl">{messages['pricing.hero.subtitle']}</p>
              <PricingToggle />
            </div>
          </section>
          ...
          <section className="px-6 pb-20 relative z-10">
            <PricingCardList />
            <p className="text-center text-xs text-navy-400 mt-6">{messages['pricing.trust.noCardRequired']}</p>
          </section>
        </div>
      </PricingPeriodProvider>
      ...
      <section className="py-20 px-6 bg-navy-950 border-t border-navy-800/40">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm text-navy-400 mb-8 max-w-lg mx-auto">{messages['pricing.cta2.subtitle']}</p>
          <BottomCtaCta />
          <p className="text-xs text-navy-400 mt-4">{messages['pricing.cta2.disclaimer']}</p>
        </div>
      </section>
    </div>
  );
