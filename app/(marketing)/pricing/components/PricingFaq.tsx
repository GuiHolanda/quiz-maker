  ...
  return (
    <div
      className={`border rounded-xl overflow-hidden transition-colors duration-200 ${
        isOpen ? 'border-white/20 bg-white/[0.07]' : 'border-white/10 bg-white/[0.03] hover:border-white/[0.18]'
      }`}
    >
      <button
        type="button"
        ...
        className="w-full flex items-center justify-between gap-4 px-6 py-5 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset rounded-xl"
        onClick={onToggle}
      >
        ...
        <span
          className={`shrink-0 w-6 h-6 rounded-full flex items-center justify-center transition-colors duration-200 ${
            isOpen ? 'bg-primary/20 text-primary' : 'bg-white/10 text-slate-400'
          }`}
        >
    ...
    <section className="py-20 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-12 max-w-2xl">
          ...
          <p className="text-sm text-slate-400">{t('pricing.faq.subtitle')}</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-x-6 lg:gap-y-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.03] px-6 py-5">
              ...
              <p className="text-sm text-slate-400">{t('pricing.faq.contactDescription')}</p>
            </div>
          </div>
        </div>
      </div>
