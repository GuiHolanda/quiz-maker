  ...
  return (
    <LegalPageShell title="Conformidade LGPD" lastUpdated="5 de agosto de 2026">
      <p>
        ...
        <strong>Lei Geral de Proteção de Dados (Lei nº 13.709/2018, LGPD)</strong>. Esta página detalha seus direitos
        como titular de dados e como exercê-los.
      </p>

      <h2>1. Papel da CertifiqueAI</h2>
      <p>
        A CertifiqueAI atua como <strong>controladora</strong> dos dados pessoais coletados em sua plataforma: define as
        finalidades e os meios do tratamento. Para detalhes sobre quais dados coletamos e com qual finalidade, consulte
        nossa <a href="/privacy">Política de Privacidade</a>.
      </p>
      <p>
        A OpenAI, o Stripe e a Vercel atuam como <strong>operadores</strong>: processam dados sob nossas instruções e em
        conformidade com seus próprios programas de privacidade.
      </p>
      ...
      <p>
        Solicitar a portabilidade dos seus dados a outro fornecedor de serviço ou produto, mediante requisição expressa,
        em formato interoperável.
      </p>

      <h3>2.5 Eliminação de dados com base em consentimento</h3>
      <p>
        Solicitar a eliminação dos dados pessoais tratados com base no seu consentimento, exceto nos casos previstos em
        lei (ex.: obrigação legal de guarda de registros fiscais).
      </p>
      ...
      <p>Ser informado sobre a possibilidade de não fornecer consentimento e sobre as consequências da negativa.</p>

      <h3>2.8 Revogação do consentimento</h3>
      <p>Revogar o consentimento a qualquer momento, sem prejuízo da licitude do tratamento realizado anteriormente.</p>
      ...
      <p>
        Respondemos a todas as solicitações em até <strong>15 dias úteis</strong>, conforme prazo estabelecido no art.
        19 da LGPD. Em casos de solicitações complexas, podemos prorrogar esse prazo com justificativa.
      </p>
      ...
      <p>
        Caso considere que seus direitos não foram adequadamente atendidos, você pode apresentar reclamação à Autoridade
        Nacional de Proteção de Dados (ANPD) através do portal{' '}
      ...
      <p>
        Em caso de incidente de segurança com risco relevante aos titulares, comunicaremos a ANPD e os usuários afetados
        dentro do prazo de 72 horas da ciência do incidente, conforme art. 48 da LGPD, com as informações exigidas por
        lei.
      </p>
    </LegalPageShell>
  );
