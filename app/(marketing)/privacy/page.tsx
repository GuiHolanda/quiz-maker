  ...
  return (
    <LegalPageShell title="Política de Privacidade" lastUpdated="5 de agosto de 2026">
      ...
      <ul>
        ...
        <li>
          <strong>Dados de faturamento:</strong> histórico de assinatura e plano ativo. Dados de cartão de crédito
          são processados exclusivamente pelo Stripe e nunca armazenados em nossos servidores.
        </li>
        <li>
      ...
      <p>
        Não vendemos seus dados. Compartilhamos apenas com parceiros essenciais para a prestação do serviço, na
        condição de operadores (LGPD art. 39):
      </p>
      <ul>
        <li>
        ...
        <li>
          <strong>Stripe (EUA):</strong> processa pagamentos e gerencia assinaturas. Opera como controlador
          independente dos dados de pagamento.
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>Dados de conta e estudo:</strong> mantidos enquanto sua conta estiver ativa. Após a exclusão da
          conta, são anonimizados ou excluídos em até 30 dias.
        </li>
        <li>
      ...
      <p>
        ...
        direito na nossa{' '}
        <a href="/lgpd">página de Conformidade LGPD</a>.
      </p>
