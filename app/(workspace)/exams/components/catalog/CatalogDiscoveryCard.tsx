...
export function CatalogDiscoveryCard({ type }: CatalogDiscoveryCardProps) {
  ...
  return (
    <NextLink className="h-full" href={`/exams/catalog?type=${type}`}>
      <div className="h-full bg-content1 border-2 border-dashed border-default-200 rounded-xl p-8 flex flex-col items-center justify-center gap-4 text-center hover:border-default-400 transition-colors cursor-pointer">
