...
const AUTH_MESSAGE_PREFIXES = ['common', 'login', 'register', 'forgotPassword', 'resetPassword', 'verify', 'toast'];

export default async function AuthLayout({ children }: { children: React.ReactNode }) {
  const messages = await loadMessagesForPrefixes(AUTH_MESSAGE_PREFIXES);
