...
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string; attemptId: string }> }) {
...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string; attemptId: string }> }) {
  const session = await auth();
