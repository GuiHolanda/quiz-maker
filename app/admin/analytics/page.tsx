                ...
                {usersData.users
                  ...
                  .map((user, i) => {
                    ...
                    return (
                      ...
                      >
                        <td className="px-4 py-3 font-mono text-xs" style={{ color: '#4d87bc' }}>
                          {i + 1}
                        </td>
                        ...
                        <td className="px-4 py-3">
                          {totalTokens > 0 ? (
                            ...
                            <span className="font-mono text-xs" style={{ color: '#4d87bc' }}>
                              —
                            </span>
                          )}
                        </td>
        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-10">
            ...
            >
              ...
              <p className="font-sora font-extrabold text-white text-2xl">
                {overview.totalInputTokens.toLocaleString('pt-BR')}
              </p>
            </div>
            <div
              className="rounded-lg p-4"
            ...
            >
              ...
              <p className="font-sora font-extrabold text-white text-2xl">
                {overview.totalOutputTokens.toLocaleString('pt-BR')}
              </p>
            </div>
            <div
              className="rounded-lg p-4"
            ...
            >
              ...
              <p className="font-mono text-xs" style={{ color: '#4d87bc' }}>
                ({overview.totalInputTokens.toLocaleString('pt-BR')} in +{' '}
                {overview.totalOutputTokens.toLocaleString('pt-BR')} out) /{' '}
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 font-mono text-xs text-white">
                        {hasRevenue ? brlFormatter.format(revenue) : <span style={{ color: '#4d87bc' }}>—</span>}
                      </td>
                      <td className="px-4 py-3">
                        {tokenCost > 0 ? (
                          <div className="flex flex-col gap-0.5">
                      ...
                      <td className={`px-4 py-3 font-mono text-xs ${marginColor}`}>
                        {margin !== null ? brlFormatter.format(margin) : <span style={{ color: '#4d87bc' }}>—</span>}
                      </td>
                      <td className={`px-4 py-3 font-mono text-xs ${marginColor}`}>
                        {marginPct !== null ? (
