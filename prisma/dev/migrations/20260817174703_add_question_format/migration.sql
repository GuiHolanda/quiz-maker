...
CREATE TABLE "new_Exam" (
    ...
    "questionFormat" TEXT NOT NULL DEFAULT 'mc_5',
...
INSERT INTO "new_Exam" ("createdAt", "examBoardId", "examDurationMinutes", "id", "isTemplate", "key", "name", "passingScore", "providerId", "role", "totalQuestions", "type", "updatedAt", "userId", "year") SELECT "createdAt", "examBoardId", "examDurationMinutes", "id", "isTemplate", "key", "name", "passingScore", "providerId", "role", "totalQuestions", "type", "updatedAt", "userId", "year" FROM "Exam";
DROP TABLE "Exam";
...
CREATE TABLE "new_ExamQuestion" (
    ...
    "format" TEXT NOT NULL DEFAULT 'mc_5',
...
INSERT INTO "new_ExamQuestion" ("correctCount", "createdAt", "difficulty", "examId", "examName", "id", "poolId", "sectionId", "sectionName", "text", "topicId", "topicName", "userId") SELECT "correctCount", "createdAt", "difficulty", "examId", "examName", "id", "poolId", "sectionId", "sectionName", "text", "topicId", "topicName", "userId" FROM "ExamQuestion";
