interface GetExplanationsParams {
...
export function buildGetPublicExamExplanationsPrompt(params: GetExplanationsParams): string {
  const { public_exam_name, exam_board_name, role, subject, topic, question } = params;
