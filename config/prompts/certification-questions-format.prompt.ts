...
{"questions":[{"id":1,"examName":"${certification_name}","sectionName":"${topic_name}","text":"<question text>","correctCount":1,"difficulty":"medium","options":{"A":"<text>","B":"<text>","C":"<text>","D":"<text>","E":"<text>"}}]}

Required fields per question: id (sequential integer starting at 1), examName, sectionName, text, correctCount (integer 1–3), difficulty (easy|medium|hard), options (object with keys A–E, all non-empty strings).`;
  },
