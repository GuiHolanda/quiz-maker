// Single source of truth for E2E seed identifiers.
// Imported by mock-data.ts (fixtures/payloads), global-setup.ts (DB seed),
// global-teardown.ts (lookup), and journey-config.ts (selectors/labels).
