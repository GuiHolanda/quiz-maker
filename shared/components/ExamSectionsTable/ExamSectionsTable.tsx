...
export const ExamSectionsTable = forwardRef<ExamSectionsTableHandle, ExamSectionsTableProps>(
  function ExamSectionsTable(
    {
      selectedExam,
      sectionsList,
      editable = false,
          ...
          <tbody>
            {sections.map((section, index) => (
              <SectionRow
                ...
                onUpdate={
                  onSectionUpdated ? (newName, min, max) => handleUpdate(section, newName, min, max) : undefined
                }
              />
            ))}
            {isAddingSection && (
