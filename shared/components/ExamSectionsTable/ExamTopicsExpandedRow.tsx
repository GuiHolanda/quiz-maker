...
import { ExamTopicItem } from './ExamTopicItem';

import { ExamTopic } from '@/shared/types';
import { useTranslation } from '@/features/hooks/useTranslation.hook';
import { inputProperties } from '@/config/constants/inputStyles';

interface ExamTopicsExpandedRowProps {
...
export function ExamTopicsExpandedRow({
  topics,
  onRemoveTopic,
  onUpdateTopic,
  onAddTopic,
}: ExamTopicsExpandedRowProps) {
          ...
          {isAdding ? (
            <div className="flex gap-1 items-center mt-1">
              <Input
                ...
                autoFocus
                className="w-56"
                placeholder={t('exam.topicNamePlaceholder')}
                size="sm"
                value={topicName}
