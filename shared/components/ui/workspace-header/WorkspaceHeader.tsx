...
export function WorkspaceHeader() {
  ...
  return (
    <header className="hidden md:flex shrink-0 bg-background/80 backdrop-blur-md border-b border-divider px-6 py-3 items-center gap-4 z-50 h-14 sticky top-0">
      <HeaderSearch />
